...
styles <- c(
  ...
  "PRE.fansi-error,PRE.fansi-warning,PRE.fansi-message {background-color:#DDAAAA;}"
)
hook.on <- c("output", "warning", "error", "message")
old.hooks <- fansi::set_knit_hooks(
  knitr::knit_hooks, which=hook.on, style=styles
)
```
